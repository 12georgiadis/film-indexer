...
**Statut :** Beta / PoC validé bout-en-bout.
...
- Injection FCPXML 1.13 : keyword ranges + markers timecodés
...
Phase 3 · Council Gemini    5 voix (Pass A + Murch + Baxter + Pagh + Synthèse)
...
Voir [goldberg-rushes-index](https://github.com/ismael-joffroy-chandoutis/goldberg-rushes-index) (privé) pour un exemple complet.
